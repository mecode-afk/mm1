...
RU_TEXTS = {
    ...
    "withdraw_unavailable": "💸 Заявка на вывод средств создана! 💸\n\n✅ Ваша заявка успешно принята в обработку.\n\n⏳ Срок обработки: до 12 часов с момента подачи заявки.\n\n📩 После обработки средства будут отправлены на указанные вами реквизиты, а вы получите уведомление.\n\n⚠️ Пожалуйста, не создавайте повторные заявки на вывод, пока текущая находится в обработке.\n\n🙏 Спасибо за использование нашего сервиса! 💙\n━━━━━━━━━━━━━━ 💰 Статус: Ожидает обработки\n⏰ Максимальное время ожидания: 12 часов ━━━━━━━━━━━━━━"
